#define NGX_CONFIGURE " --prefix=build --with-cc-opt=-Wno-error --error-log-path=logs/error.log --http-log-path=logs/access.log --with-http_ssl_module --add-module=nginx-rtmp-module-1.1.7"
